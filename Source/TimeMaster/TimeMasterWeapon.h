...
#include "TimeMasterWeapon.generated.h"

class ITimeMasterWeaponHolder;
...
UCLASS()
class TIMEMASTER_API ATimeMasterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	ITimeMasterWeaponHolder* WeaponOwner;
