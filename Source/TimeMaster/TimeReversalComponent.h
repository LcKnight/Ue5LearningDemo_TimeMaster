...
public:	
	...
	UFUNCTION(BlueprintCallable, Category = "Time Reversal")
	void ToggleDelegateBinding();

	UFUNCTION(BlueprintCallable)
	bool GetTimeReversing() { return IsTimeReversing; };

	UPROPERTY(EditAnywhere, Category = "TimeReversalInfo")
	int ReversalSpeed;
